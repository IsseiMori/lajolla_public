...
struct eval_op {
    ...
    Spectrum operator()(const HairBSDF &bsdf) const;
...
struct pdf_sample_bsdf_op {
    ...
    Real operator()(const HairBSDF &bsdf) const;
...
struct sample_bsdf_op {
    ...
    std::optional<BSDFSampleRecord> operator()(const HairBSDF &bsdf) const;
...
struct get_texture_op {
    ...
    TextureSpectrum operator()(const HairBSDF &bsdf) const;
};
...
#include "materials/hair_bsdf.inl"
